...
if st.session_state["authentication_status"]:
    ...
    with st.expander("Contenido Permitido", expanded=True):
        st.page_link("hidden_pages/Pedidos.py", disabled=False)
        st.page_link("hidden_pages/Soporte Tecnico.py", disabled=False)
        st.page_link("hidden_pages/Administración.py", disabled=True)
